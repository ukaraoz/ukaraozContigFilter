...
def get_microtrait_datatables(datatables_dir, output_files=None):
    if output_files is None:
        output_files = dict()
    hmm_matrix_loc = os.path.join(datatables_dir, 'hmm_matrix.txt')
    output_files['hmm_matrix'] = {'path': hmm_matrix_loc,
                                   'name': 'hmm_matrix.txt',
                                   'label': 'hmm_matrix.txt',
                                   'description': 'Microtrait hmm output in tabular format'}
    rule_matrix_loc = os.path.join(datatables_dir, 'rule_matrix.txt')
    ...
    trait_matrixatgranularity1_loc = os.path.join(datatables_dir, 'trait_matrixatgranularity1.txt')
    ...
    trait_matrixatgranularity2_loc = os.path.join(datatables_dir, 'trait_matrixatgranularity2.txt')
    ...
    trait_matrixatgranularity3_loc = os.path.join(datatables_dir, 'trait_matrixatgranularity3.txt')
    ...
    guild2traitprofile_loc = os.path.join(datatables_dir, 'guild2traitprofile.txt')
